      ...
      <div className='flex items-center gap-5'>
            ...
            <div className="relative inline-block">
                ...
                <div 
                      ...
                      className='flex items-center gap-2 bg-primary hover:bg-secondary p-1 px-3 rounded-md
                      transition-all delay-100 ease-in-out cursor-pointer text-secondary hover:text-primary'>
                ...
                <div className='bg-transparent p-2 rounded-md cursor-pointer text-secondary hover:bg-secondary hover:text-primary'>
                    <AiFillNotification className='2xl'/>
                </div>
      </div>
  </div>
</div>
